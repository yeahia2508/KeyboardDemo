...
public class SoftKeyboard extends InputMethodService 
        ...
        if (mCompletionOn) {
            ...
            for (int i = 0; i < completions.length; i++) {
                ...
                if (ci != null) {
                    ...
                    Log.i("arif--- onDisplay: ", ci.getText().toString());
                }
            }
    ...
    private void updateCandidates() {
        if (!mCompletionOn) {
            if (mComposing.length() > 0) {
                ...
                //mScs.getSuggestions(new TextInfo(mComposing.toString()), 3);
    ...
    private void dumpSuggestionsInfoInternal(
        ...
        for (int j = 0; j < len; ++j) {
            ...
            //Log.i("arif", si.getSuggestionAt(j));
        }
    }
...
//
//                for(int k=0; k < m; k++) {
//                    sb.add(result.getSuggestionsInfoAt(i).getSuggestionAt(k));
//                }
//            }
//        }
//
